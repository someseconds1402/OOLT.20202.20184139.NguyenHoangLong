...
class DiscTest {
	...
	void test2() {
		...
		DigitalVideoDisc dvd4 = new DigitalVideoDisc("Dmitri Ivanovich Mendeleev", "Nightmare",
				"Chemical periodic table", 200, 100.0f);

		DigitalVideoDisc dvd5 = new DigitalVideoDisc("Fujiko F. Fujio", "Fiction", "Doraemon", 8120, 20.05f);

		DigitalVideoDisc dvd6 = new DigitalVideoDisc("Bit Bucket", "Coder", "Javascipt", 66, 15.33f);
